...
"""
Above import statement allow to find the module, loads and initialize the module
it defines a name of names in the local namespace (folder) for the scope where
import statement happens
"""
"""
